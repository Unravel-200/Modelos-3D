...
# Soda de Estudios Generales: 15 x 12 m
# (Proyecto_Memoria_Definitivo_3_Dias_Terror_Intenso.txt, seccion 10.2)
# Conectada detras del vestibulo (SM_VestibuloBlockout_Generales_A), cuya
# pared trasera esta en Y=6.0 con hueco de 2.00 m centrado en X=0.
...
# pared trasera cerrada por ahora (cocina/bodega de la soda, sin salida
# definida hacia el resto del edificio todavia)
...
mesh_obj.name = "SM_SodaBlockout_Generales_A"
mesh_obj.data.name = "SM_SodaBlockout_Generales_A_Mesh"
...
mat_floor = bpy.data.materials.new(name="M_Floor_SodaBlockout")
...
mat_wall = bpy.data.materials.new(name="M_Wall_SodaBlockout")
...
col_floor.name = "UCX_SM_SodaBlockout_Generales_A_00"
...
bpy.ops.wm.save_as_mainfile(
    filepath="C:\\Users\\jeffa\\Desktop\\Proyecto\\Modelos-3D\\Generales\\SM_SodaBlockout_Generales_A.blend")
