...
# Recepcion de la Biblioteca Central: 6 x 8 m
# (Proyecto_Memoria_Definitivo_3_Dias_Terror_Intenso.txt, seccion 10.1)
# Posicionada justo detras del vestibulo (SM_VestibuloBlockout_Library_A),
# que mide 12x15 m centrado en el origen: su pared trasera esta en Y=7.5,
# con un hueco de 1.80 m centrado en X=0. Esta sala continua desde ahi.

ROOM_W = 6.0
ROOM_D = 8.0
FLOOR_THICK = 0.20
WALL_THICK = 0.15   # pared interior (Guia, seccion 4)
WALL_H = 4.5

VESTIBULO_BACK_Y = 7.5
FRONT_DOOR_W = 1.80   # coincide con el hueco del vestibulo
BACK_DOOR_W = 1.20     # abertura hacia vigilancia (puerta interior sencilla)

ROOM_CENTER_Y = VESTIBULO_BACK_Y + ROOM_D / 2.0
...
half_w = ROOM_W / 2.0
front_y = VESTIBULO_BACK_Y
back_y = VESTIBULO_BACK_Y + ROOM_D

# piso
add_box("Floor", ROOM_W, ROOM_D, FLOOR_THICK, (0.0, ROOM_CENTER_Y, -FLOOR_THICK / 2.0))

# pared frontal (hacia el vestibulo), con hueco de FRONT_DOOR_W
...
# pared trasera (hacia vigilancia), con hueco de BACK_DOOR_W
...
mesh_obj.name = "SM_RecepcionBlockout_Library_A"
mesh_obj.data.name = "SM_RecepcionBlockout_Library_A_Mesh"

# el pivote se deja en el origen del mundo (0,0,0), NO se recentra en el
# objeto, porque esta pieza debe alinearse con el vestibulo ya colocado.
...
mat_floor = bpy.data.materials.new(name="M_Floor_RecepcionBlockout")
...
mat_wall = bpy.data.materials.new(name="M_Wall_RecepcionBlockout")
...
col_floor.name = "UCX_SM_RecepcionBlockout_Library_A_00"
...
bpy.ops.wm.save_as_mainfile(
    filepath="C:\\Users\\jeffa\\Desktop\\Proyecto\\Modelos-3D\\Biblioteca\\SM_RecepcionBlockout_Library_A.blend")
